...
export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 font-playfair">
        Privacy Policy
      </h1>
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <p>
          At SCENTILUXE ("we," "our," or "us"), we value your privacy and are
        ...
        <ul>
          ...
          <li>Usage data (pages viewed, time spent on site, clicks)</li>
        ...
        <p>
          ...
          our website. You can manage cookie preferences through your browser
          settings.
        </p>
        ...
        <p>
          ...
          <br />
          Address: 123 Fragrance Avenue, Suite 456, Lahore, Pakistan 54000
        </p>
      </div>
    </div>
  );
