...
export default function CartDrawer() {
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-hidden">
            ...
            <div
                className={`absolute inset-0 backdrop-blur-sm bg-black/30 transition-opacity duration-300 ease-in-out ${isVisible ? 'opacity-100' : 'opacity-0'
                    }`}
                onClick={closeCart}
            />
            ...
            <div className="fixed inset-y-0 right-0 max-w-full flex">
                <div
                    ref={cartRef}
                    className={`w-full sm:w-96 bg-white shadow-xl flex flex-col transform transition-transform duration-300 ease-in-out ${isVisible ? 'translate-x-0' : 'translate-x-full'
                        }`}
                >
                    {/* Cart Header */}
                                            ...
                                            <div className="ml-4 flex-1">
                                                <div className="flex justify-between">
                                                    <div>
                                                        ...
                                                        {item.volume && (
                                                            <p className="mt-1 text-xs text-gray-500">{item.volume}</p>
                                                        )}
                                                    </div>
